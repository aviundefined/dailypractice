...
public class SlidingWindowMaximumTest {
    ...
    public void maxSlidingWindow1() {
        ...
        final int[] actual = solver.maxSlidingWindow_Deque(nums, k);
    ...
    @Test
    public void maxSlidingWindow_Stack1() {
        final SlidingWindowMaximum solver = new SlidingWindowMaximum();
        final int[] nums = {1, 3, -1, -3, 5, 3, 6, 7};
        final int k = 3;
        final int[] expected = {3, 3, 5, 5, 6, 7};
        final int[] actual = solver.maxSlidingWindow_Stack(nums, k);
        System.out.println("Expected: " + Arrays.toString(expected));
        System.out.println("actual: " + Arrays.toString(actual));
        Assert.assertArrayEquals(expected, actual);
    }
    ...
    @Test
    public void maxSlidingWindow_Stack2() {
        final SlidingWindowMaximum solver = new SlidingWindowMaximum();
        final int[] nums = {1, -1};
        final int k = 1;
        final int[] expected = {1, -1};
    ...
    @Test
    public void maxSlidingWindow_Stack3() {
        final SlidingWindowMaximum solver = new SlidingWindowMaximum();
        final int[] nums = {7, 2, 4};
        final int k = 2;
        final int[] expected = {7, 4};
